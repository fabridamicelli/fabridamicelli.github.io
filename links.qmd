...
## Tools
  ...
  - [Find out which AI models your machine can actually run](https://www.canirun.ai/)
  - [ttl.sh: Ephemeral container registry](https://ttl.sh/)
  - [sli.dev: Presentation Slides for Developers](https://sli.dev/)
